...
export default defineAction({
  ...
  async run(ctx) {
    ...
    await copicu.log.info("inspected enrichment result", {
      ...
      manualApplyAllowed: current.manualApplyAllowed,
    ...
    const markdownLines = [
      ...
      "- Auto apply active: `" + String(finalResult.autoApplyEnabled) + "`",
      "- Manual apply allowed: `" + String(finalResult.manualApplyAllowed) + "`",
