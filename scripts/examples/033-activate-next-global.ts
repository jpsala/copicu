...
export default defineAction({
  id: "examples.activateNextGlobal",
  title: "Activate next item",
  description: "Activates the next clipboard item and shows which item became active.",
  ...
  logging: {
    name: "activate-next-global.jsonl",
  },
  async run(ctx: ActionContext) {
    ...
    await copicu.log.info("activated next clipboard item");
  },
});
