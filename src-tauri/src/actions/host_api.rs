...
use super::{
    ...
    script_enrichment_get_result, script_enrichment_run_for_item, script_history_create,
    script_history_get, script_history_move, script_history_neighbor, script_history_promote,
    script_history_remove, script_history_search, script_history_update,
    script_metadata_edit_active, script_metadata_list_tags, script_ui_alert, script_ui_confirm,
    script_ui_input, ActionDefinition, ScriptHostCall,
};
...
pub(super) fn dispatch_script_host_call<R: Runtime + 'static>(
    ...
    let result = match call.method.as_str() {
        ...
        "history.create" => script_history_create(storage, call.payload.clone()),
