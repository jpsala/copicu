      ...
      <div className="scenario-switcher-panel">
        <header className="scenario-switcher-header">
          <div>
            ...
            <span>Save the current picker search as an active workspace.</span>
          </div>
          <UiTooltip label="Close scenario creator">
            <UiIconButton type="button" variant="subtle" aria-label="Close scenario creator" onClick={onClose}>
        ...
        >
          ...
          <div className="scenario-create-actions">
            ...
            <UiButton type="button" variant="default" loading={busy} disabled={!draft.name.trim()} onClick={() => void submitCreate(false)}>Save scenario</UiButton>
