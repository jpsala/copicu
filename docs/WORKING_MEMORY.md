...
| Open source/release | active | `docs/tracks/018-public-launch-readiness.md`, `docs/tracks/013-open-source-growth.md`, `docs/topics/windows-installer.md` | `v0.3.0` publicado; issues sembrados borrados de GitHub. Proximo: dogfood instalada/update y feedback real. |
