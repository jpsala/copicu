...
| Open source/release | active | `docs/tracks/018-public-launch-readiness.md`, `docs/tracks/021-distribution-trust-code-signing.md`, `docs/topics/windows-installer.md` | `v0.4.10` estable publicado; feed firmado reparado sin BOM y check manual nativo operativo. |
