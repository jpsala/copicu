...
| Open source/release | active | `docs/tracks/018-public-launch-readiness.md`, `docs/tracks/021-distribution-trust-code-signing.md`, `docs/topics/windows-installer.md` | `v0.4.1` estable publicado con instalador, firma de updater y `latest.json`; instalada local promovida y respondiendo. |
