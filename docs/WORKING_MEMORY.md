...
| --- | --- | --- | --- |
| Appearance / picker batch menus | complete/distributed | `docs/topics/appearance-and-themes.md`, `docs/topics/picker-interaction.md` | Dogfood de `v0.4.21`; no confundirlo con la investigación del hang intermitente. |
