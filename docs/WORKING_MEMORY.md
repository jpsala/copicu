...
| Actions/scripts/hotkeys | complete | `docs/tracks/012-tags-and-hotkeys.md`, `docs/topics/tag-management-hotkeys.md`, `docs/tracks/004-actions-scripting.md` | Metadata global simplificada a un textarea: `#tokens` inline se parsean a tags, el resto a notes; `title` no se expone. |
...
| Open source/release | active | `docs/tracks/018-public-launch-readiness.md`, `docs/tracks/021-distribution-trust-code-signing.md`, `docs/topics/windows-installer.md` | `v0.3.9` estable; `v0.4.0-rc.2` en feature freeze sin reemplazar el canal stable. Proximo: observar regresiones y promover a `v0.4.0`. |
