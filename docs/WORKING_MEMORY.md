...
- **Siguiente acción:** ninguna; item preview publicado en `v0.4.1-rc.1`.
...
| Open source/release | active | `docs/tracks/018-public-launch-readiness.md`, `docs/tracks/021-distribution-trust-code-signing.md`, `docs/topics/windows-installer.md` | `v0.3.9` estable; `v0.4.1-rc.1` publicado como prerelease con item preview, pausa de captura y polish de ventanas/menus. |
