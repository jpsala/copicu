...
- GitHub auth en Pi esta OK y `main` esta sincronizado con `origin/main`; quedan cambios OS/.pi no mezclados en working tree.
...
3. Mantener como secundarios: formalizar bateria picker/Computer Use, actions modularization y patch preview de shortcuts si JP lo pide.
