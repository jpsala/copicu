...
| Open source/release | active | `docs/tracks/018-public-launch-readiness.md`, `docs/tracks/021-distribution-trust-code-signing.md`, `docs/topics/windows-installer.md` | `v0.4.11` estable publicado con subtags jerarquicos y refresh del autocomplete; feed firmado operativo. |
