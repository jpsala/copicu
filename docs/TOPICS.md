...
| Computer dogfood, research opt-in y gates de efectos externos | [Agent Tool Routing](topics/agent-tool-routing.md), [technical-research-process](topics/technical-research-process.md) |
## Documentos Raiz
