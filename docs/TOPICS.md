...
| Open source, GitHub publico, README publico, web del proyecto, contributors, promocion, growth, Show HN | [Open Source And GitHub](topics/open-source-github.md), [Open Source Growth](tracks/013-open-source-growth.md), [Public Launch Readiness](tracks/018-public-launch-readiness.md) | Decisiones, checklist, audit previo, launch readiness y plan de promocion. |
...
| Realinear os, auditar sistema agentico, reparar sistema agentico, drift de contexto, upstream/downstream, manager-only | [Operaciones Del Sistema Agentico](topics/agentic-os-operations.md) | Playbook para auditar, reparar y actualizar la capa agentica local sin tocar producto ni copiar metasistema AOS. |
